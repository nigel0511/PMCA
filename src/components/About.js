      ...
      <section className="page-section" id="about">
        <div className="container">
          <div className="text-center">
            <h2 className="section-heading text-uppercase">About Our Music School</h2>
          ...
          <div className="row text-center">
            ...
            <div className="col-md-4">
              ...
              <p className="text-muted">
                Our teachers had practical experience performing with
                professional orchestras and music groups after gaining
                bachelor/master degree from music schools. You might have
                already met them if you are regular concert-goer!
              </p>
            </div>
            <div className="col-md-4">
              <span className="fa-stack fa-4x">
